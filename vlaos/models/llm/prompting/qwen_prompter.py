...
SYS_PROMPTS = "You are Qwen, created by Alibaba Cloud. You are a helpful assistant."

class QwenPromptBuilder(PromptBuilder):
    def __init__(self, model_family: str, system_prompt: Optional[str] = None) -> None:
        super().__init__(model_family, system_prompt)

        self.system_prompt = (SYS_PROMPTS if system_prompt is None else system_prompt).strip()
